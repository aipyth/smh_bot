...
const addOrderTypeWizard = new Scenes.WizardScene(
  ...
  async (ctx) => {
    ...
    const confirmationText = formatMessage(responses.addOrderType.confirmation, {
    ...
    await ctx.reply(confirmationText, {
      ...
      ...Markup.inlineKeyboard([
        Markup.button.callback(responses.addOrderType.confirmButton, 'confirm_add'),
        Markup.button.callback(responses.addOrderType.cancelButton, 'cancel_add')
      ])
    });
    return ctx.wizard.next();
  },
